...
export const RegisterForm: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center bg-gradient-to-br from-purple-50 to-pink-100 p-8">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Beginne deine Reise mit KnowledgeFlow</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="mt-8 relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-gray-500">Bereits registriert?</span>
              </div>
            </div>
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-purple-600 via-pink-600 to-red-600 p-12 items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 text-white max-w-lg">
          <h2 className="text-5xl font-bold mb-6 leading-tight">
            Werde Teil von<br />KnowledgeFlow
          </h2>
          <p className="text-xl text-purple-100 mb-8">
            Tausende nutzen bereits KnowledgeFlow, um ihr Wissen zu organisieren und produktiver zu werden.
          </p>
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <p className="ml-4 text-lg">Sofort einsatzbereit</p>
            </div>
            ...
            <div className="flex items-center">
              ...
              <p className="ml-4 text-lg">Für Teams & Einzelpersonen</p>
            </div>
            ...
            <div className="flex items-center">
              ...
              <p className="ml-4 text-lg">Komplett kostenlos</p>
            </div>
          </div>
        </div>
      </div>
